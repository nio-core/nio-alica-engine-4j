...
public class ExpressionHandler {
    ...
    private final UtilityFunctionCreator utilityCreator;
    private final ConstraintCreator constraintCreator;

    public ExpressionHandler(AlicaEngine ae, ConditionCreator cc, UtilityFunctionCreator uc, ConstraintCreator crc) {
        this.ae = ae;
